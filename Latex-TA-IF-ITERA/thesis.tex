...
% Editor: Radhinka Bagaskara, Martin C.T. Manullang, I Wayan Wiprayoga Wisesa, Jose Alfredo Sitanggang (IF 2016), Ardoni Yeriko Rifana Gultom (IF 2021), Syabana Minggus Noviantosa (IF 2018), Rizki Alfaina (IF 2021), Cornelius Linux (IF 2022)
% Version 2026.1
...
% Berdasarkan Pedoman Tugas Akhir Format Terbaru (UNESCO)
% https://docs.google.com/document/d/1m2WutVlV-NSbEeZUKMPsThl__LI8m_bd
%
%--------------------------------------------------------------------%
%
...
\begin{document}
    ...
    \title{Rancang Bangun Sistem Monitoring Pelaporan Kinerja Unit Menggunakan Metode Modified Waterfall (Studi Kasus: PT KAI Divre I Sumatera Utara)}
    \newcommand{\coverTitle}{Rancang Bangun Sistem Monitoring Pelaporan Kinerja Unit Menggunakan Metode Modified Waterfall\\[0.15\baselineskip](Studi Kasus: PT KAI Divre I Sumatera Utara)}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{Design and Development of Unit Performance Reporting Monitoring System Using Modified Waterfall Method (Case Study: PT KAI Divre I North Sumatra)}
    % JUDUL AKAN DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris

    % Informasi Mahasiswa
	\author{Rachel Olivia Manullang}	% Nama Mahasiswa
	\nim{122140181}						% NIM Mahasiswa
