...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figure/usecase_user_unit.drawio (1).png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figure/usecase_admin_global.drawio (1) (1).png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figure/usecase_it_support.drawio (1).png}
