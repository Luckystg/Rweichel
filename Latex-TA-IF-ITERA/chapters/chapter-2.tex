...
\subsection{Teknik Sampling} \label{II.Sampling}
Teknik sampling merupakan cara yang digunakan untuk menentukan jumlah dan anggota sampel yang akan dijadikan responden dalam suatu penelitian dari keseluruhan populasi yang ada \cite{syahrum2021pilar}. Pemilihan teknik sampling yang tepat sangat penting untuk memastikan bahwa data yang diperoleh dapat merepresentasikan kebutuhan dan pengalaman pengguna secara akurat sesuai dengan tujuan pengujian yang dilakukan. \par

Penelitian ini menggunakan \textit{Purposive Sampling}, yaitu teknik pengambilan sampel yang dilakukan secara sengaja berdasarkan pertimbangan dan kriteria tertentu yang ditetapkan oleh peneliti sesuai dengan tujuan penelitian \cite{andrade2021purposive}. Teknik ini dipilih karena tidak semua anggota populasi memiliki keterlibatan langsung dalam proses pelaporan harian, sehingga hanya responden yang memenuhi kriteria tertentu yang dilibatkan dalam pengujian. \par

Kriteria responden yang ditetapkan dalam penelitian ini adalah sebagai berikut:
\begin{description}
    \item[User Unit] Pegawai yang bertugas secara langsung melakukan penginputan laporan kinerja harian pada unit KNA, Angkutan Penumpang, Angkutan Barang, dan Keuangan di lingkungan PT KAI Divre I Sumatera Utara, dengan jumlah 2-3 orang per unit.
    \item[Admin Global] Pegawai yang bertugas mereview, menyetujui, atau merevisi laporan yang masuk dari seluruh unit kerja, dengan jumlah 2-3 orang.
    \item[IT Support] Pegawai yang bertugas mengelola sistem, menangani kendala teknis, dan memproses permintaan helpdesk, dengan jumlah 5 orang.
\end{description}
...
\subsubsection*{C. User Acceptance Testing (UAT)} \label{II.UAT}
